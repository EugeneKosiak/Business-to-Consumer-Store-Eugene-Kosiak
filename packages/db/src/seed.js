...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, posts_1, post, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("🌱 Seeding data");
                    return [4 /*yield*/, client.like.deleteMany()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, client.post.deleteMany()];
                case 2:
                    _a.sent();
                    _i = 0, posts_1 = data_1.posts;
                    _a.label = 3;
                case 3:
                    if (!(_i < posts_1.length)) return [3 /*break*/, 9];
                    post = posts_1[_i];
                    return [4 /*yield*/, client.post.create({
                            data: {
                                title: post.title,
                                content: post.content,
                                category: post.category,
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5:
                    if (!(i < post.likes)) return [3 /*break*/, 8];
                    return [4 /*yield*/, client.like.create({
                            data: {
                                postId: post.id,
                                userIP: "192.168.100.".concat(i),
                            },
                        })];
                case 6:
                    _a.sent();
